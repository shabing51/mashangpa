...
base_url = 'https://spiderbuf.cn/web-scraping-practice/scraping-douban-movies-xpath-advanced'
...
def parseHTML(html):
    ...
    # </div>
        if i % 2 == 0:
            ...
            # print(div.xpath('./div/div/span[contains(text(),"豆瓣电影评分:")]/following::text()'))
            rating = ''
            if len(ratings) > 0:
