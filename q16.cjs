...
document = {
    all: [],
    documentElement: {},
    createElement: function(arg){if(arg==='script'){return script};if(arg==='canvas'){return canvas};console.log(`document.createElement(${arg})\n`)},
    createEvent: function(...arg){console.log(`document.createEvent(${arg})\n`)},
    querySelector: function(arg){console.log(`document.querySelector(${arg})\n`)},
    cookie: 'v=QXlCeEtINm9VLUF4dmVJenN2SjZKRWFrOFNYM0tRVHpwZzFZOTVveDdEdk9sYzRiUWpuVWdfWWRLSVhwMTc4Mzk1MzYxOTg3Nw==; _nano_fp=XpmJXqUyXqE8n5XblT_tWl0Gg6HZvZIjMMZPNCs1; Hm_lvt_0d2227abf9548feda3b9cb6fddee26c0=1783126091,1783901828,1783944118,1783986954; HMACCOUNT=07888F147EF39D67; Hm_lpvt_0d2227abf9548feda3b9cb6fddee26c0=1784002588',
    body:{},
    head:{},
...
//get_Envs(['window', 'document', "navigator", "localStorage", 'screen', 'canvas'])

let log_ = console.log;
console.log = function (params) {
    if (params == 'load rac js fail!'){
        ;
    }else{
        log_(params);
    }
