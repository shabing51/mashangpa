...
head = {baseURI: "https://stu.tulingpyton.cn/problem-detail/15/"}
document = {}
document.head = head
documentElement = {
    clientHeight: 212,
...
document.toString = function(){return 'ƒ toString() { [native code] }'}
document.getElementsByTagName = function (arg) {
        console.log("对象：document =====>方法：getElementsByTagName ===>参数：", arg)
    }

setProxyArr(["window", "document", "head", "div", "navigator", ])
